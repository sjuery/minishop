...
<body>
	...
	<table>
		...
		<td>
			...
			<figcaption class="info"><p>Green Apples<br><strong class="price">1.75$ per</strong></p>
			<input type="submit" value="Add to basquet"></figcaption></figure>
		</td>
		<td>
			<figure><img src="https://c2.staticflickr.com/4/3365/3421750128_04e11ca4e1_b.jpg">
			<figcaption class="info"><p>Blue Apples<br><strong class="price">25$ per</strong></p>
			<input type="submit" value="Add to basquet"></figcaption></figure>
		</td>
	</table>
	<table>
		<td>
			...
			<figcaption class="info"><p>Yellow Bananas<br><strong class="price">1$ per</strong></p>
			<input type="submit" value="Add to basquet"></figcaption></figure>
		</td>
		<td>
			<figure><img src="https://img.aws.livestrongcdn.com/ls-article-image-673/ds-photo/getty/article/103/51/457512575.jpg">
			<figcaption class="info"><p>Green Bananas<br><strong class="price">75c per</strong></p>
			<input type="submit" value="Add to basquet"></figcaption></figure>
		</td>
		<td>
			<figure><img src="https://cdn3.volusion.com/lcezu.ypudg/v/vspfiles/photos/bluebanana-3.jpg?1403955729">
			<figcaption class="info"><p>Blue Bananas<br><strong class="price">397$ per</strong></p>
			<input type="submit" value="Add to basquet"></figcaption></figure>
		</td>
	</table>
</body>
